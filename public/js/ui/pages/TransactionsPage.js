...
class TransactionsPage {
  ...
  constructor(element) {
    if (!element) {
      throw new Error("в TransactionsPage не передан элемент");
    }
  ...
  registerEvents() {
    this.element.addEventListener("click", (e) => {
      ...
      if (removeTransactionBtn) {
        this.removeTransaction(removeTransactionBtn.getAttribute("data-id"));
      }
    });
  }
  ...
  formatDate(date) {
    ...
    let currentDay = currentDate.toLocaleDateString("ru", {
      day: "numeric",
      month: "long",
      year: "numeric",
    });
    let currentTime = currentDate.toLocaleString("ru", {
      hour: "numeric",
      minute: "numeric",
    });
